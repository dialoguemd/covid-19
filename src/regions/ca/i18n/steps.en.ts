export default {
  ...
  intro3:
    "Before starting, if you experience severe symptoms like heavy or crushing chest pain, symptoms of a stroke or difficulty breathing, please contact 911 or go to the emergency with no delay. Note that the information you'll receive is not a medical assessment. The information we supply is from publicly available sources and is subject to frequent change.",
