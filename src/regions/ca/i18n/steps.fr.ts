export default {
  ...
  Par **contact étroit**, j'entends **n'importe lequel** des éléments suivants :
	...
	- Exposition liée aux soins de santé, comme le fait de prodiguer des soins à des patients infectés, de leur rendre visite ou d’êtree rester avec eux dans le même environnement proche
	- Travailler à proximité ou partager la même salle de classe avec une personne infectée
